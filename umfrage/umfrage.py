    ...
    async def umfrage(self,ctx,land = None):
        ...
        for i in data.values(): 
            ...
            if pruefparl == currparl:
                ...
                plt.savefig('/home/pi/Umfrage.png', dpi=300, facecolor='#e7eef4') #Speichere die Grafik. Speicherpfad kann geändert werden, dann aber bitte darauf achten, dass dies auch unten beim Senden gemacht wird. 
                break

        await ctx.send(embed=embed) #Sende embed
        await ctx.send(file=discord.File('/home/pi/Umfrage.png', 'Umfrage.png')) #Sende Grafik
